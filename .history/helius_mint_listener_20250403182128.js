...
console.log("🚨 Helius listener started — scanning for token mints every 50s...");
...
console.log("🚨 Helius listener started — scanning for token mints every 5s...");
setInterval(pollForMints, 5000);
